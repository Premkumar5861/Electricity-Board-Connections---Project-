...
class Applicant(models.Model):
        ...
        GovtID_Type=models.CharField(max_length=20,choices=GOVT_ID_CHOICE)
...
class Connection(models.Model):
    ...
    Reviewer_Comments=models.CharField(max_length=50,choices=REVIEWERS_COMMENTS_CHOICE)
